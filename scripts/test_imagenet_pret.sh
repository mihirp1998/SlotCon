...
output_dir="./output/test_imagenet_classify_ours_motion_blur-5_fix_510"
...
CUDA_VISIBLE_DEVICES=0 torchrun --master_port 12344 --nproc_per_node=1 \
    ...
    --cont-weight 0.0  --do-only-classification --only-test --resume output/imagenet_classify_73_pret_sup6_loaded/current.pth 
    # --d
